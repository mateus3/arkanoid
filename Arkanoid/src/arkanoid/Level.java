...
import arkanoid.Main.MainFrame;
...
public class Level extends Parent {
        ...
        KeyFrame kf = new KeyFrame(Config.ANIMATION_TIME, new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                if (ballDirY > 0 &&
                    ...
                    // korekcja wektorów piłki X i Y
                    
                    double offsetX = newX + ball.getDiameter() / 2 - bat.getTranslateX() - bat.getWidth() / 2;
                    
                    // jeśli odbicie środkiem deski nie zmieniaj kierunku
                ...
                // określenie uderzenia piłki w kostke
    ...
    // panel po prawej stronie ze statystykami

    private void initInfoPanel() {
        infoPanel = new Group();
        roundCaption = new Text();
        roundCaption.setText("PLANSZA");
